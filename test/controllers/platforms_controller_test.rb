...
class PlatformsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create platform" do
    assert_difference('Platform.count') do
      post platforms_url, params: { platform: { answer: @platform.answer, question: @platform.question } }, as: :json
    end
  ...
  test "should update platform" do
    patch platform_url(@platform), params: { platform: { answer: @platform.answer, question: @platform.question } }, as: :json
    assert_response 200
  end
